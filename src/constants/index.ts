...
export const homeText = {
        ...
        about: 'I create elegant, interactive web experiences using modern technologies, with a focus on clean code, refined design, and effortless user interactions.',
